        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pictures = table.Column<string>(type: "NVARCHAR2(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gender = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: false),
                    Email = table.Column<string>(type: "NVARCHAR2(255)", maxLength: 255, nullable: false),
                    PhoneNumber = table.Column<string>(type: "NVARCHAR2(255)", maxLength: 255, nullable: false),
                    PassportNumber = table.Column<string>(type: "NVARCHAR2(255)", maxLength: 255, nullable: false),
                    Country = table.Column<string>(type: "NVARCHAR2(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoomID = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    RoomNumber = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: false),
                    RoomType = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: false),
                    AvailabilityStatus = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: false),
                    Floor = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    BedCount = table.Column<int>(type: "NUMBER(10)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerID = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    RoomID = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    CheckInDate = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    CheckOutDate = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BillingID = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    ReservationID = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    CustomerId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    RoomId = table.Column<int>(type: "NUMBER(10)", nullable: false),
